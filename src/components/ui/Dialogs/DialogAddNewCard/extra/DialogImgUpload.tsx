    ...
    <>
      ...
      {!isEditQuestionPicture ? (
        <>
          {!props.cropQuestionImg ? (
            ...
            <div className={sC.imgContainer}>
              <img className={sC.croppedImg} src={props.cropQuestionImg} alt="cropImg" />
            </div>
          )}
          <Button
            variant="secondary"
        ...
        <ComboFileCropperSliderApprove
          ...
          cropSuggestionText={'Plz select question img'}
        />
      )}
      ...
      {!isEditAnswerPicture ? (
        <>
          {!props.cropAnswerImg ? (
            ...
            <div className={sC.imgContainer}>
              <img className={sC.croppedImg} src={props.cropAnswerImg} alt="cropImg" />
            </div>
          )}
          <Button
            variant="secondary"
        ...
        <>
          <ComboFileCropperSliderApprove
            ...
            slider={{
              sliderValue: sliderAnswerValue,
              sliderChangeHandler: sliderAnswerChangeHandler,
            }}
            onApprove={onApproveAnswer}
            cropSuggestionText={'Plz select answer img'}
          />
        </>
      )}
    </>
