...
import {ExtraDeckImgUpload} from "@/components/ui/Dialogs/ExtraDeckImgUpload.tsx"
        ...
        >
            <div className={sC.DialogDescription}>
                <div className={sC.dialogElement}>
                    <ExtraDeckImgUpload cropImg={cropImg} setCropImg={setCropImg} onApproveCallback={onApprove}/>
                </div>
