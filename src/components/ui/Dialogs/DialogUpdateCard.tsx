...
export const DialogUpdateCard = (props: Props) => {
  ...
  const [cropQuestionImg, setCropQuestionImg] = useState<string | undefined>(
    props.selectedCard.questionImg
  )
  const [cropAnswerImg, setCropAnswerImg] = useState<string | undefined>(
    props.selectedCard.answerImg
  )
  ...
  const onUpdateCard = async (
    question: string,
    answer: string,
    coverQuestionImg?: string,
    coverAnswerImg?: string,
    ...
    if (
      isQuestionChanged ||
      isAnswerChanged ||
      isCoverQuestionChanged ||
      isCoverAnswerChanged ||
      isQuestionVideoChanged ||
      isAnswerVideoChanged
    ) {
